...
const double FTOP = 77.2392;   //场地上
const double FBOT = 6.3730;    // 场地下
const double GTOPY = 49.6801;   //         球门上
const double GBOTY = 33.9320;   //         球门下
const double GRIGHT = 97.3632;   //        球门右边
const double GLEFT = 2.8748;    //                 球门左边界
const double FRIGHTX = 93.4259; //场地的右边
const double FLEFTX = 6.8118;   //场地的左边
